...
await redis.zadd('leaderboard', { score: 250, member: 'player2' }, { score: 150, member: 'player3' });
...
await redis.zadd('scores', { score: 1, member: 'a' }, { score: 2, member: 'b' }, { score: 3, member: 'c' });
...
await redis.zadd('items', { score: 1, member: 'a' }, { score: 2, member: 'b' }, { score: 3, member: 'c' });
